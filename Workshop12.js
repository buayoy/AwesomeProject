    ...
    render() {
        return (
            <View style={{padding: 10,flex:1,flexDirection:'column' ,justifyContent:'center'}}>
                <Image style={{width: undefined, height:100}} resizeMode='stretch' source={require('./img/avengersposters.jpg')} />
                <Image style={{height : 500 , width:undefined}} resizeMode='stretch' source={{uri:"https://www.sideshowtoy.com/wp-content/uploads/2018/04/marvel-avengers-infinity-war-thanos-sixth-scale-figure-hot-toys-feature-903429-1.jpg"}}/>
          </View> 
        );
    }
}
